...
if __name__ == "__main__":
    ...
    try:
        ...
        #csv_raster=f"../analysis/data/first/meas_{nd}_{bias}_raster_scan_{timestamp}.csv"
        #raster_scan.snake_scan(0, 10, 0, 10, .1, raster_scan.measure, ser, keithley, siglent, csv_raster)  
        
        xcsv=f"../analysis/data/first/meas_{nd}_{bias}_xline_scan_{timestamp}.csv"
        ycsv=f"../analysis/data/first/meas_{nd}_{bias}_yline_scan_{timestamp}.csv"
        ...
        csv_center=f"../analysis/data/first/meas_{nd}_{bias}_center_scan_{timestamp}.csv"
